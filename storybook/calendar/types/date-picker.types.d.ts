...
import { DOMAttributes, FieldOptions, Granularity, LabelableProps, OverlayTriggerState, RangeValue, TimeValue, ValidationState } from './calendar.types';
import { FocusableProps, HelpTextProps, Validation, ValueBase } from './common.types';
import { AriaBaseButtonProps, ButtonProps, LinkButtonProps } from './element.types';
...
export interface DatePickerBase<T extends DateValue> extends DateFieldBase<T>, OverlayTriggerProps {
}
export interface DatePickerProps<T extends DateValue> extends DatePickerBase<T>, ValueBase<T> {
}

import { AriaRole, CSSProperties, DragEvent, KeyboardEvent, MouseEvent, ReactNode, TouchEvent } from '../../../../../node_modules/.pnpm/react@18.3.1/node_modules/react';
import { Calendar, CalendarDate, CalendarDateTime, DateFormatter, Time, ZonedDateTime } from '../../internationalized/date';
import { HelpTextProps } from './common.types';
import { AriaDatePickerProps } from './date-picker.types';
import { AriaLabelingProps, DOMProps, SpectrumLabelableProps } from './label.types';
...
export interface SpectrumDateFieldBase extends SpectrumLabelableProps, HelpTextProps {
    isQuiet?: boolean;
    showFormatHelpText?: boolean;
}
export interface SpectrumDatePickerBase extends SpectrumDateFieldBase, SpectrumLabelableProps {

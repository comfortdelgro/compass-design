...
import { DOMAttributes, Granularity, LabelableProps, SegmentType } from './calendar.types';
import { FocusableProps, HelpTextProps, Validation, ValueBase } from './common.types';
...
export interface DateFieldBase<T extends DateValue> extends InputBase, Validation, FocusableProps, LabelableProps, HelpTextProps, OverlayTriggerProps {
    minValue?: DateValue;
    maxValue?: DateValue;
...
export interface DateFieldProps<T extends DateValue> extends DateFieldBase<T>, ValueBase<T | null> {
}
...
export type AriaDateFieldOptions<T extends DateValue> = Omit<AriaDateFieldProps<T>, 'value' | 'defaultValue' | 'onChange' | 'minValue' | 'maxValue' | 'placeholderValue'>;

    ...
    return (
      <div {...htmlProps} ref={tagItemRef} className={itemClass}>
        ...
        <input
          ...
          className={classNames(styles.itemInput, 'cdg-tag-box-item-input')}
          onBlur={onBlur}
          onKeyDown={onKeyDown}
        ...
        <button
          ...
          className={classNames(styles.itemButton, 'cdg-tag-box-item-button')}
        ...
        >
          <svg
            ...
            fill='none'
            viewBox='0 0 12 12'
            className={classNames(styles.itemSvg, 'cdg-tag-box-item-icon')}
          >
            <path

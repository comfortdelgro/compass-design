...
const VGFlag: React.FC = () => (
  ...
  >
    ...
    <g transform='translate(-217.5 -9.4) scale(.77497)'>
      ...
      />
      <g id='c' fill='#ffc72c' stroke='#000' strokeWidth={0.9}>
        <path
          fill='none'
          stroke='#ffc72c'
          strokeWidth={1.9}
      ...
      <use xlinkHref='#c' width='100%' height='100%' x={-0.8} y={41.3} />
      <use xlinkHref='#c' width='100%' height='100%' x={-1.1} y={82} />
      <use xlinkHref='#c' width='100%' height='100%' x={25.6} y={126.1} />
      <use xlinkHref='#c' width='100%' height='100%' x={-4.6} y={162.2} />
      <use xlinkHref='#c' width='100%' height='100%' x={-3.8} y={204.8} />
      <use xlinkHref='#c' width='100%' height='100%' x={146.3} y={0.7} />
      <use xlinkHref='#c' width='100%' height='100%' x={144.9} y={41.2} />
      <use xlinkHref='#c' width='100%' height='100%' x={143.1} y={82.7} />
      <use xlinkHref='#c' width='100%' height='100%' x={145.2} y={123.4} />
      <use xlinkHref='#c' width='100%' height='100%' x={144.7} y={164.2} />
      <use xlinkHref='#c' width='100%' height='100%' x={144.9} y={205.2} />

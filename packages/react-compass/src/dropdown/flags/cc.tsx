...
const CCFlag: React.FC = () => (
  ...
  >
    ...
    <g fill='#ffe000' transform='translate(0 80) scale(.0635)'>
      <use xlinkHref='#a' width='100%' height='100%' x={7560} y={4200} />
      <use xlinkHref='#a' width='100%' height='100%' x={6300} y={2205} />
      <use xlinkHref='#a' width='100%' height='100%' x={7560} y={840} />
      <use xlinkHref='#a' width='100%' height='100%' x={8680} y={1869} />
      <use xlinkHref='#b' width='100%' height='100%' x={8064} y={2730} />
    </g>
  </svg>
)

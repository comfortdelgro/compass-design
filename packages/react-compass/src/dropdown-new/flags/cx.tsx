...
const CXFlag: React.FC = () => (
  ...
  >
    ...
    <g fill='#fff' transform='matrix(.64 0 0 .64 0 80)'>
      ...
      <use xlinkHref='#a' width='100%' height='100%' x={2.5} y={269.1} />
      <use xlinkHref='#a' width='100%' height='100%' x={-112.1} y={123.2} />
      <use xlinkHref='#a' width='100%' height='100%' x={108.4} y={85} />
    </g>
  </svg>
)

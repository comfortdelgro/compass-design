...
import styles from './styles/confirm-pickup.module.css'
...
const ConfirmPUPoint = memo(
  forwardRef<HTMLDivElement, ConfirmPUPointProps>((props, ref) => {
    const {
      css = {},
      className,
      puPointTitle,
    ...
    return (
      <CssInjection css={css} childrenRef={componentRef}>
        <div {...htmlDivAttributes} ref={componentRef} className={rootClasses}>
          <div
            className={classNames(
              styles.puPointAddress,
              'cdg-cp-point-address',
            )}
          >
            <div>
              <div
                className={classNames(
                  styles.puPointAddressTitle,
                  'cdg-cp-point-address__title',
                )}
              >
                {puPointTitle}
              </div>
              <div
                className={classNames(
                  styles.puPointAddressDescription,
            ...
            <Button
              className={classNames(
                styles.puPointAddressIcon,
                'cdg-cp-point-address__icon',
              )}
              variant='ghost'
          ...
          <div
            className={classNames(styles.puPointLabel, 'cdg-cp-point-label')}
          >
          ...
          {initialSpecificPUPoint ? (
            <div
              className={classNames(
                styles.puSpecificLocation,
                'cdg-cp-specific-location',
              )}
            >
              <svg
                width='12'
                ...
                xmlns='http://www.w3.org/2000/svg'
                className={classNames(
                  styles.puSpecificLocationSVG,
                  'cdg-cp-specific-location__svg',
                )}
              >
                <path
              ...
              <div
                className={classNames(
                  styles.puSpecificLocationName,
                  'cdg-cp-specific-location__name',
                )}
              >
                {initialSpecificPUPoint}
              </div>
            ...
            <TextField
              className={classNames(styles.puTextField, 'cdg-cp-textfield')}
              placeholder={placeholder}
              onChange={(value) => setSpecificPickupPoint(value.toString())}
            />
          )}
          <Button
            className={classNames(styles.puConfirmButton, 'cdg-cp-button')}

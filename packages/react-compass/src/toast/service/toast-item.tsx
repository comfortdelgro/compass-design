...
const ToastItem = ({
  ...
  // classes
  const toastItemClasses = classNames(
    horizontal === 'left' && styles.toastItemHorizontalLeft,
    horizontal === 'right' && styles.toastItemHorizontalRight,
    horizontal === 'center' && styles.toastItemHorizontalCenter,
    vertical === 'bottom' &&
      horizontal === 'center' &&
  ...
  return (
    <div ref={toastItemRef} className={toastItemClasses}>
      <Toast
        ...
        className={classNames(toastItemClassName, itemClassName)}

      ...
      return (
        <CssInjection css={css} childrenRef={componentRef}>
          <div
            ref={componentRef}
            className={clsx(
              classes.confirmPickup,
              'confirm-pickup-container',
              className,
            )}
            {...htmlDivAttributes}
          >
            <div className={clsx(classes.puPointAddress, 'pu-point-address')}>
              <div>
                <div
                  className={clsx(
                    classes.puPointAddressTitle,
                ...
                <div
                  className={clsx(
                    classes.puPointAddressDescription,
            ...
            <div className={clsx(classes.puPointLabel, 'pu-point-label')}>
            ...
            {initialSpecificPUPoint ? (
              ...
              >
                ...
                <div
                  className={clsx(
                    classes.puSpecificLocationName,
              ...
              <TextField
                className={clsx(classes.puTextField, 'pu-textfield')}
            ...
            <Button
              className={clsx(classes.puConfirmButton, 'confirm-pu-button')}

 ...
 */
export default function SlideDragger({ slideRef, icon, onDrag, onDragEnd, disableDrag, }: SlideDraggerProps): import('../../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime').JSX.Element;

...
export type SlideDraggerProps = {
    ...
    icon?: ReactNode;
    onDrag?: (slideDragInfo: {
        slideDragWidth: number;
        maxSlideDistance: number;
    }, ...params: Parameters<NonNullable<DraggableOptions['onMove']>>) => void;
    onDragEnd?: (slideDragInfo: {
        slideDragWidth: number;
        maxSlideDistance: number;
    }, ...params: Parameters<NonNullable<DraggableOptions['onEnd']>>) => void;
    disableDrag?: boolean;
};
export {};

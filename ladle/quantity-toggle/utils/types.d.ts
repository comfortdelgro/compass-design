...
export interface AriaNumberFieldProps extends NumberFieldProps, TextInputDOMEvents {
    id?: string;
...
export interface TextInputDOMProps extends DOMProps, TextInputDOMEvents {
    ...
    placeholder?: string;
    autoComplete?: string;
    type?: 'text' | 'search' | 'url' | 'tel' | 'email' | 'password' | (string & object);
...
export interface DOMAttributes<T = FocusableElement> extends React.AriaAttributes, React.DOMAttributes<T> {
    id?: string | undefined;
...
type CompositionEventHandler<T = Element> = React.EventHandler<React.CompositionEvent<T>>;
...
type ClipboardEventHandler<T = Element> = React.EventHandler<React.ClipboardEvent<T>>;
...
export interface AriaTextFieldProps extends TextFieldProps, AriaLabelingProps, FocusableDOMProps, TextInputDOMProps, AriaValidationProps, Omit<React.HTMLAttributes<HTMLInputElement>, keyof TextFieldProps> {

...
import { CalendarPropsBase, DOMAttributes, RangeValue, SpectrumDatePickerBase } from './calendar.types';
import { ValueBase } from './common.types';
import { AriaButtonProps, AriaDatePickerBaseProps, AriaDatePickerProps, AriaDialogProps, DatePickerBase } from './date-picker.types';
import { AriaLabelingProps, DOMProps } from './label.types';
export interface DateRangePickerProps<T extends DateValue> extends DatePickerBase<T>, ValueBase<RangeValue<T> | null> {
...
export interface SpectrumRangeCalendarProps<T extends DateValue> extends AriaRangeCalendarProps<T> {

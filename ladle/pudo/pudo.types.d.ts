import { CSSProperties, FocusEvent, FocusEventHandler, ReactNode } from '../../../../node_modules/.pnpm/react@18.3.1/node_modules/react';
...
export type PudoProps<TItemKeys extends PropertyKey> = {
     ...
     */
    onItemFocusChange?: (focusingItem?: TItemKeys, event?: FocusEvent<HTMLInputElement, Element>) => void;

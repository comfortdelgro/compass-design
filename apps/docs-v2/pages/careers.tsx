      ...
      <Container>
        ...
        >
          ...
          <Typography component='h1' variant='h2' sx={{my: 1}}>
            Build the <GradientText>next generation</GradientText> of tools for
            UI development
          </Typography>
          <Typography
            color='text.secondary'
          ...
          >
            Our mission is to enable developers at every level of ability to
            build great UIs, faster.
          </Typography>
        </Box>
      </Container>
      {/* Our ultimate goal */}
          ...
          <Grid container alignItems='center' spacing={4}>
            <Grid item xs={12} md={6}>
              ...
              <Typography color='text.secondary' sx={{mb: 1, maxWidth: 450}}>
                ...
                tool for building UIs, for developers and designers. MUI started
                back in 2014, to unify React and Material Design. Since then,
                we&apos;ve become a community of over 2M developers from every
                corner of the world.
              </Typography>
      ...
      <Container sx={{py: {xs: 4, md: 8}}}>
        <div>
          <Typography variant='h2' sx={{my: 1}} id='open-roles'>
            {`Open roles (${openRolesData.reduce(
              (acc, item) => acc + item.roles.length,
              0,
            )})`}
          </Typography>
          <Typography color='text.secondary' sx={{mb: 2, maxWidth: 500}}>
            The company is bootstrapped (so far). It was incorporated in
            mid-2019 and is growing fast (x2-3 YoY). We doubled the team in 2020
            (6), accelerated in 2021 (15), kept a similar pace in 2022 (25), and
            we plan to triple it in 2023 (75). We&apos;re looking for help to
      ...
      {nextRolesData.length > 0 ? (
        <Box data-mui-color-scheme='dark' sx={{bgcolor: 'primaryDark.700'}}>
          <Container sx={{py: {xs: 4, md: 8}}}>
            ...
            >
              <div>
                ...
                <Typography color='text.secondary' sx={{mb: 2, maxWidth: 450}}>
                  We hire in batches, we collect applications a few months
                  before we actively aim to fill the roles. If none of these
                  roles fit with what you are looking for, you can apply to the{' '}
            ...
            <Divider
              sx={{my: {xs: 2, sm: 4}, borderColor: 'primaryDark.600'}}
            />
            <Stack
              spacing={2}
              divider={
                <Divider
                  sx={{my: {xs: 1, sm: 2}, borderColor: 'primaryDark.600'}}
                />
              }
            >
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              >
                We&apos;re to help you with any other question you have about
                our hiring process.
              </Typography>

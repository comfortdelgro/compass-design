...
var Root = react_compass_1.styled('div', {
    lineHeight: 1.5625,
...
var MarkdownElement = React.forwardRef(function MarkdownElement(props, ref) {
    var _a = props, className = _a.className, renderedMarkdown = _a.renderedMarkdown, other = __rest(_a, ["className", "renderedMarkdown"]);
    var more = {};
    if (typeof renderedMarkdown === 'string') {
        // @ts-ignore
        more.dangerouslySetInnerHTML = { __html: renderedMarkdown };
    }
    return (React.createElement(Root, __assign({ className: clsx_1["default"]('markdown-body', className) }, more, other, { ref: ref })));
});

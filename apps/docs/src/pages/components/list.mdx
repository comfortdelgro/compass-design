...
<section className={styles.componentShowcaseContainer}>
  <DragAndDropListV2>
    <DragAndDropListV2.Item key='1'>Item 1</DragAndDropListV2.Item>
    <DragAndDropListV2.Item key='2'>Item 2</DragAndDropListV2.Item>
    <DragAndDropListV2.Item key='3'>Item 3</DragAndDropListV2.Item>
  </DragAndDropListV2>
</section>

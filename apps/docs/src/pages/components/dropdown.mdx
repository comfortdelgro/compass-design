...
<section className={styles.avatarShowcaseContainer}>
  <Dropdown.Select label='Favorite Animal' isRequired placeholder='Choose an animal' defaultSelectedKey='cat'>
    <Dropdown.Item
      key='red panda'
...
<section className={styles.avatarShowcaseContainer}>
  <Dropdown.ComboBox label='Favorite Animal' isRequired placeholder='Choose an animal' defaultSelectedKey='cat'>
    <Dropdown.Item
      key='red panda'
      leftIcon={<Icon icon={faExclamationTriangle} />}
    >
...
<section className={styles.avatarShowcaseContainer}>
  <Dropdown.Flag label='List of country' isRequired placeholder='Choose a country' keyType='phone-code' />
</section>

...
export const DropdownsForm: React.FC = () => {
  ...
  const {control, handleSubmit, formState, setValue} = useForm<Inputs>({
    ...
    defaultValues: {gender: 'male', nationality: 'SGP', hobbies: ['dancing']},
          ...
          return (
            <Fragment>
              <MultipleDropdown
                ...
                isErrored={Boolean(fieldState.error)}
              >
                <MultipleDropdown.Item key='male'>Male</MultipleDropdown.Item>
                <MultipleDropdown.Item key='female'>
                  Female

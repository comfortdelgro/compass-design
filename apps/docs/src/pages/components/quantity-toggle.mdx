...
| disabledScroll  | `boolean`                      | `false` | Whether the scroll to change value is disabled.                                                                                                           |
...
| onHandle        | `(value: string) => void`      | —       | Handler that is called when the value changes like onChange but it return raw data                                                                        |

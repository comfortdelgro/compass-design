...
<Callout>
  Check out our [ladle](/ladle?story=card--sizes) for more info on this
  component.
</Callout>
## Example
  ...
  return (
    <Card size='lg'>
      <Card.Body>
        ...
        <p>This is a paragraph within a card body</p>
        <Card.Action>
          <Button className='c-hKssGC-hYGuEl-variant-primary' variant='primary'>Button</Button>
...
<ComponentDisplay>
  <Card size='sm' isClickable onClick={() => alert('clicked')}>
    <Card.Body>
      ...
      <p>This is a paragraph within a card body</p>
      <Card.Action>
        <Button className='c-hKssGC-hYGuEl-variant-primary'>Button</Button>
      </Card.Action>
    </Card.Body>
  </Card>
</ComponentDisplay>

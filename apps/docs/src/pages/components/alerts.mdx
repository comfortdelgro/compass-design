...
<section className={styles.componentShowcaseContainer}>
  ...
  <Alert color='success'>This is an sucess alert — check it out!</Alert>
  <Alert color='danger'>This is an danger alert — check it out!</Alert>
  <Alert color='warning'>This is an warning alert — check it out!</Alert>
</section>
...
| :---------- | :--------------------- | :------ | :-------------------------------------------------------------------------------------- |
| children    | `ReactNode` \|`String` | —       | The content to display in the accordion.                                                |
| dismissible | `boolean`              | `false` | If true, show the close icon.                                                           |
| onDismiss   | `function`             | —       | Callback to close close the alerts.                                                     |

...
import {ReactTableFullFeature, ReactTableBasic} from 'components/TableV2'
...
| :--------------- | :------ | :------ | :------------------------- |
| `enableResizing` | boolean | `true`  | `Set enable column resize` |

##### Enable column filter

| Name                 | Type    | Default | Description                |
| :------------------- | :------ | :------ | :------------------------- |
| `enableColumnFilter` | boolean | `true`  | `Set enable column filter` |

##### Enable Grouping

| Name             | Type    | Default | Description                  |
| :--------------- | :------ | :------ | :--------------------------- |
| `enableGrouping` | boolean | `true`  | `Set enable column grouping` |

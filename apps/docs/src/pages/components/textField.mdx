...
<section className={styles.avatarShowcaseContainer}>
  <Textfield label='Name' leftIcon={faThumbsUp} placeholder='Enter your name' />
  <Textfield
    label='Name'
...
| `rightIcon`   | `IconProp`\|`false`\| `true` | `false` | `Icon placed on the right side of the text field` |
| `leftIcon`    | `IconProp`\|`false`\| `true` | `false` | `Icon placed on the left side of the text field`  |

...
<section className={styles.componentShowcaseContainer}>
  <RangeCalendar hasFooter ctaButtonRender={<Button className='c-hKssGC-hYGuEl-variant-primary'>Today</Button>} />
</section>
...
<section className={styles.componentShowcaseContainer}>
  <RangeCalendar hasFooter ctaButtonRender={<Button className='c-hKssGC-hYGuEl-variant-primary'>Custom Button</Button>} />
</section>

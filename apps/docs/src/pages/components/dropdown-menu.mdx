...
<Callout>
  Check out our [ladle](/ladle?story=dropdown-menu--default) for more info on
  this component.
</Callout>
...
| onSelect   | `Function`  | —       | A callback fired when a menu item is selected((event: React.MouseEvent<HTMLLIElement>, eventKey: any) => void) |

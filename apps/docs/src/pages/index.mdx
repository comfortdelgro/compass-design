...
<div
  ...
  style={{
    backgroundImage: 'url(/workbench-design/banner.png)',
  }}
/>
...
```bash
npm i @comfortdelgro/react-workbench
```
...
```bash
yarn add @comfortdelgro/react-workbench
```
...
```bash
pnpm add @comfortdelgro/react-workbench
```

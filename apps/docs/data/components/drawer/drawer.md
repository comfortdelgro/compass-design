...
| `onHeightChange`   | `(height: number) => void`          | —                                                                    | Trigger when the drawer's height changes.                                                                                                                                                                                                  |
| `onExpandChange`   | `(isExpand: boolean) => void`       | —                                                                    | Trigger when the drawer expanded.                                                                                                                                                                                                          |
...
| `disableResize`    | `boolean`                           | `false`                                                              | If `true`, the drawer will NOT be able to expand/collapse and the expander line will be hidden.                                                                                                                                            |
| `disableDragClose` | `boolean`                           | `false`                                                              | If `true`, the drawer will NOT close itself if user drags and drops it below the default height.                                                                                                                                           |

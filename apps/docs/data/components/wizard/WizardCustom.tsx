...
function BasicExample() {
  return (
    <>
      ...
      {/* <StaticsWizard currentStep={5}>
        <StaticsWizard.Item title='Value1'>
          <div
            style={{
              width: 20,
              height: 20,
        ...
        <StaticsWizard.Item title='Value2'>
          <div
            style={{
              width: 20,
              height: 20,
        ...
        <StaticsWizard.Item title='Value3'>
          <div
            style={{
              width: 20,
              height: 20,
        ...
        <StaticsWizard.Item title='Value4'>
          <div
            style={{
              width: 20,
              height: 20,
        ...
        <StaticsWizard.Item title='Value5'>
          <div
            style={{
              width: 20,
              height: 20,
        ...
        <StaticsWizard.Item title='Value6'>
          <div
            style={{
              width: 20,
              height: 20,
